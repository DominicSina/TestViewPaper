...
side with limited but more focused content in the right code editor. 
Being able to view method and test side by side results in an easy to use help for whitebox testing. 
...
When the TVPlugin does not find some test methods then it might be because their test 
class is not considered to be a test class to the currently in Nautilus selected method. All 
test methods in this missing test class will not be found and thus not be shown in the 
found tests drop list. Here you find step by step instructions of how to add your test class
to the considered test classes.

\begin{enumerate}

\item Make sure that in the Nautilus class hierarchy you have selected the method 
which is missing tests in the found tests drop down list.
