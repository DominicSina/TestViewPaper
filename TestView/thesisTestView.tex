...
of the problems\ins{ or with the participant not being familiar with the
plugin}. Everybody seemed to have more difficulty with the
...
we made a Nautilus plugin\del{(} called TestView Plugin or TVPlugin\del{)}.
...
very decisive. While all participants \ugh{liked the plugin}\brs{did they?} the
...
\emph{setUp} methods also would be found\ins{you never mentioned the setUp
