...
\section{Troubleshooting}
	...
	%tests are missing in the found tests droplist
	%%%link your desired tests class
	%%%your tests do not conform to the rules, change them
	
	%too many tests are shown in the found tests droplist
	%%%unlink the wrongly identified test classes
	
	%I only some tests from a method to be removed or added to the shown tests droplist
	%%%not possible linking and unlinking is currently only possible on a class level
